...
<article id="post-<?php the_ID(); ?>"  <?php post_class(); ?>>
    ...
    <div class="row">
        <div class="col-md-3 img-responsive img-radius img-border">
            ...
            <div class="post-info"><span><?php the_time("j F Y"); ?> </span> / <span> <?php the_category(', '); ?></span> / <span> <?php comments_popup_link( __('بدون دیدگاه', 'max-mag'), __( '1 دیدگاه', 'max-mag'), __('% دیدگاه', 'max-mag')); ?></span> /
