...
<section class="my-post format-status">
	...
	<div class="row">
		<div class="col-md-3 img-responsive img-radius img-border">
			...
			<div class="info"><span><?php the_time("j F Y");?> </span> / <span> <?php the_category(', '); ?></span> / <span class="icon-bubble"></span></div>
		</div>
		<div class="col-md-9">
			<section class="status-content">
				<a class="title" href="<?php the_permalink() ?>"><?php the_title(); ?>. </a>
				<?php $content = get_the_content(); echo $content ?><?php edit_post_link("ویرایش ","<span class='edit-link'>","</span>");?>
			</section>
		</div>
	</div>
