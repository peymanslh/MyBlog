<div class="btn-dd" id="share-this">
    ...
    <button type="button" id="btn-share" data-toggle="dropdown" class="btn"><?php _e('Share this post', 'myblog'); ?>
    ...
    <ul class="dropdown">
        ...
        <li>
            <a href="http://www.linkedin.com/sharearticle?mini=true&url=<?php the_permalink(); ?>&title=<?php the_title(); ?>"
               class="c-linkedin"><span class="icon-linkedin"></span> <?php _e('Linkedin', 'myblog'); ?></a></li>
        <li>
